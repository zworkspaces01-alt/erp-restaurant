...
-- ==============================================================================
-- 20. CÁC HÀM RPC QUẢN TRỊ NGƯỜI DÙNG (DÀNH CHO CHỦ NHÀ HÀNG - OWNER)
-- ==============================================================================

-- 20.1 Tạo tài khoản người dùng mới
...
-- 20.2 Liệt kê danh sách người dùng kèm vai trò
...
-- 20.3 Đặt lại mật khẩu người dùng
